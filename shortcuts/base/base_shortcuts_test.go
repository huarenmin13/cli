...
func TestBaseFieldUpdateHelpGuidesAgents(t *testing.T) {
	...
	wantTips := []string{
		...
		"only when the user explicitly asks to rename the field or column",
		"is not rename authorization",
		"current type and options already express the requested values or transitions",
		"preserve the field name and schema",
		"do not guess a bulk value update",
