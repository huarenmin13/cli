...
var BaseFieldList = common.Shortcut{
	...
	Flags: []common.Flag{
		...
		{Name: "limit", Type: "int", Default: "200", Desc: "pagination size, range 1-200"},
	...
	Validate: func(ctx context.Context, runtime *common.RuntimeContext) error {
		...
		if _, err := common.ValidatePageSizeTyped(runtime, "limit", 200, 1, 200); err != nil {
			return err
		}
		if runtime.Changed("page-size") {
			if _, err := common.ValidatePageSizeTyped(runtime, "page-size", 200, 1, 200); err != nil {
				return err
			}
		}
		return nil
